...
public class Main {
    ...
    private static void displayMainMenu() {
        ...
        System.out.println("6. Sort Menu Items");
        System.out.println("7. Evaluate Menu Item");
        System.out.println("8. Feedback");
        System.out.println("9. Reward/Penalty");
    ...
    // =====================================================
    // SEARCH MENU ITEM - BINARY SEARCH
    // =====================================================
    ...
    private static void searchMenuItem() {
        ...
        // Sort menu items by ID before Binary Search
        ...
        if (item == null) {
            ...
            System.out.println(
                    "Item found using Binary Search:"
            );
    ...
    private static void sortMenuItems() {
        ...
        System.out.println(
                "Menu items sorted successfully."
        );
